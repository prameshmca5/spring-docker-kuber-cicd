  ...
  booleanParam(name: 'SKIP_TESTS', defaultValue:
                                     true, description: 'Skip running tests')
  booleanParam(name: 'CLEAN_BUILD', defaultValue:
                                      true, description: 'Perform clean build')
  booleanParam(name: 'DEPLOY_BACKEND', defaultValue:
                                         true, description: 'Deploy Backend via Helm')
  booleanParam(name: 'DEPLOY_FRONTEND', defaultValue:
                                          true, description: 'Deploy Frontend via Helm')
  booleanParam(name: 'DEPLOY_DATABASE', defaultValue:
                                          false, description: 'Deploy Database Infrastructure')
  booleanParam(name: 'DEPLOY_MONITORING', defaultValue:
                                            false, description: 'Deploy Monitoring Stack (Loki + Promtail + Grafana)')
